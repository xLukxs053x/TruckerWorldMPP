...
async def create_ticket(interaction: discord.Interaction, bot: TruckerWorldBot) -> None:
    ...
    if isinstance(conflict, dict):
        ...
        embed.add_field(name="20-day policy", value="Recently closed tickets can be reopened directly in TWMP Support. Please do not create a duplicate.", inline=False)
...
async def close_ticket(interaction: discord.Interaction, bot: TruckerWorldBot) -> None:
    ...
    try:
        ...
        closed_embed.add_field(name="Need to continue?", value="For the next 20 days, reopen this same ticket directly in TWMP Support instead of creating a duplicate.", inline=False)
